...
<div class="wrap">
    ...
    <div class="narrow">
        <form method="post">
            <p><?php echo __('Ace Editor is a fully functional self-contained code syntax highlighter developed in JavaScript.', 'wp_su') ?></p>
            ...
            <table class="form-table">
                <tr>
                    ...
                    <td>
                        ...
                        <input type="number" name="wp_su_options[cacheday]" id="wpSuCacheDay" min="0" max="999"
                            value="<?php echo $this->options['cacheday']; ?>" requried/>
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <input type="number" name="wp_su_options[mdb5length]" id="wpSuMdb5Length" min="16" max="32"
                            value="<?php echo $this->options['mdb5length']; ?>" requried/>
                    </td>
                </tr>
                <tr>
                ...
                <tr>
                    <th scope="row"><?php echo __('Don\'t display to unregistered user', 'wp_su') ?></th>
                    <td>
                        <input type="checkbox" name="wp_su_options[unregistered]" id="wpSuUnregistered" value="1"
                            <?php echo ($this->options['unregistered'] == '1') ? 'checked' : '' ?>/>
                    </td>
                </tr>
                <tr>
                    <th scope="row"><?php echo __('Don\'t display to unregistered user', 'wp_su') ?></th>
