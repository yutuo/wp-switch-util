    ...
    <div class="narrow">
        <form method="post">
            ...
            <table class="form-table">
                ...
                <tr>
                    <th scope="row"><?php echo __('Disable emoji', 'wp_su') ?></th>
                    <td>
                        <input type="checkbox" name="wp_su_options[disableemoji]" id="wpDisableEmoji" value="1"
                            <?php echo ($this->getOption('disableemoji') == '1') ? 'checked' : '' ?>/>
                    </td>
                </tr>
            </table>
            <p class="submit">
